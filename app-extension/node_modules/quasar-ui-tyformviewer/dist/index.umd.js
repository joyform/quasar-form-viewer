/*!
 * quasar-ui-tyformviewer v0.1.48
...
(function (global, factory) {
  ...
  var script$8 = {
    ...
    components: {
      ...
      TyDate: vue.defineAsyncComponent(function () { return Promise.resolve().then(function () { return TyDate; }); }),
    },
    props: {
      blockSchema: Object,
  ...
  var script$7 = vue.defineComponent({
    name: 'TyFormViewer',
    components: {
      Block: script$8, QForm: quasar.QForm, QCard: quasar.QCard, QParallax: quasar.QParallax,QImg: quasar.QImg, QCardSection: quasar.QCardSection
    },
    props: {
      formSchema: {
        type: Object,
  ...
  var script$6 = {
    ...
    setup: function setup (props, ref) {
      ...
      var modelValueRef = vue.computed({
        ...
        set: function (val) {emit('update:modelValue', val);}
      });
  ...
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", null, [
      ...
      (!!$props.hint)
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$3, vue.toDisplayString($props.hint), 1))
        : vue.createCommentVNode("", true)
    ]))
  }
  ...
  var _hoisted_1$2 = { class: "col ty-rating" };
  var _hoisted_2 = {
    key: 0,
    class: "text-caption q-ml-sm text-grey-8"
  };
  ...
  var script = {
    ...
    setup: function setup (props, ref) {
      ...
      var inputModel = vue.computed(function () { return ({
        type: 'text',
        mask: props.range ? '##/##/#### - ##/##/####' : '##/##/####',
        label: props.label,
        name: props.name,
      ...
      var formSchema = vue.inject('formSchema');
      var pickerModelValue = vue.computed({
        get: function () {
          return props.modelValue
        },
        set: function (val) {emit('update:modelValue', val);}
      });
      var inputModelValue = vue.computed({
        get: function () {
        ...
        set: function (val) {
          var ref = val.split('-').map(function (v) { return v.trim(); });
          var from = ref[0];
          var to = ref[1];
          emit('update:modelValue', {from: from, to: to});
        }
      });
      return {
        ...
        pickerModelValue: pickerModelValue
      }
    }
  };

  var _hoisted_1 = { class: "row items-center justify-end" };
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    var _component_TyInput = vue.resolveComponent("TyInput");
    ...
    return (vue.openBlock(), vue.createBlock(_component_TyInput, vue.mergeProps($setup.inputModel, {
      ...
      "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) { return ($setup.inputModelValue = $event); })
    }), {
      append: vue.withCtx(function () { return [
            ...
            vue.createVNode(_component_q_popup_proxy, {
              ...
              default: vue.withCtx(function () { return [
                vue.createVNode(_component_q_date, {
                  ...
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) { return ($setup.pickerModelValue = $event); }),
                  mask: "DD/MM/YYYY",
                  range: $props.range
                }, {
                  default: vue.withCtx(function () { return [
